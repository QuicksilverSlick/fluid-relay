...
export interface BackendSession {
  ...
  /** Send the protocol-specific capabilities initialization frame.
   *  Optional — only adapters that support a native initialize handshake
   *  (e.g. Claude NDJSON) implement this. Adapters that negotiate capabilities
   *  through other means (Codex, ACP, etc.) omit it. */
